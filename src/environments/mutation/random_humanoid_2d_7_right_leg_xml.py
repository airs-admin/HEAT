...
right_leg_2_torso_height = 0.465
...
# List joint & actuator.
joint_options = [("left_hip_y", 150), ("left_knee", 100), ("right_shoulder1", 12.5), ("right_elbow", 12.5), 
                 ("left_shoulder1", 12.5), ("left_elbow", 12.5)]
selected_joints = []
unselected_joints = []
...
with open(log_file, "a") as log:
    log.write(f"humanoid_2d_7_right_leg_{index}, range_len: {range_len}, disable_prob: {disable_prob}, "
              f"left_thigh_length: {left_thigh_length}, right_thigh_length: disabled, "
...
output_file = os.path.join(output_dir, f"humanoid_2d_7_right_leg_{index}.xml")
