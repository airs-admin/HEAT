...
# List joint & actuator.
joint_options = [("bthigh", 120), ("bshin", 90), ("bfoot", 60), ("fthigh", 120), ("fshin", 60)]
selected_joints = []
unselected_joints = []
...
with open(log_file, "a") as log:
    log.write(f"cheetah_6_back_{index}, range_len: {range_len}, disable_prob: {disable_prob}, "
...
output_file = os.path.join(output_dir, f"cheetah_6_back_{index}.xml")
