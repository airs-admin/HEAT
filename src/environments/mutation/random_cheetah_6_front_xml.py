...
# Create torso body
torso = ET.SubElement(worldbody, "body", name="torso", pos="0 0 .7")
...
# List joint & actuator.
joint_options = [("bthigh", 120), ("bshin", 90), ("fthigh", 120), ("fshin", 60), ("ffoot", 30)]
selected_joints = []
unselected_joints = []
...
with open(log_file, "a") as log:
    log.write(f"cheetah_6_front_{index}, range_len: {range_len}, disable_prob: {disable_prob}, "
...
output_file = os.path.join(output_dir, f"cheetah_6_front_{index}.xml")
