...
ET.SubElement(right_shin, "geom", fromto=f"0 0 0 0 0 {-right_shin_length}", name="right_shin1", size="0.049", type="capsule")
...
# List joint & actuator.
joint_options = [("right_hip_y", 150), ("right_knee", 100), ("right_shoulder1", 12.5), ("right_elbow", 12.5), 
...
with open(log_file, "a") as log:
    log.write(f"humanoid_2d_7_left_leg_{index}, range_len: {range_len}, disable_prob: {disable_prob}, "
              f"left_thigh_length: disabled right_thigh_length: {right_thigh_length}, "
...
output_file = os.path.join(output_dir, f"humanoid_2d_7_left_leg_{index}.xml")
