...
# List joint & actuator.
joint_options = [("fthigh", 120), ("fshin", 60)]
selected_joints = []
unselected_joints = []
...
with open(log_file, "a") as log:
    log.write(f"cheetah_3_front_{index}, range_len: {range_len}, disable_prob: {disable_prob}, "
...
output_file = os.path.join(output_dir, f"cheetah_3_front_{index}.xml")
