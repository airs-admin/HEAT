...
# List joint & actuator.
joint_options = [("right_hip_y", 150), ("right_knee", 100), ("left_hip_y", 150), ("left_knee", 100),
                 ("right_shoulder1", 12.5), ("right_elbow", 12.5), ("left_shoulder1", 12.5), ("left_elbow", 12.5)]
selected_joints = []
unselected_joints = []
...
with open(log_file, "a") as log:
    log.write(f"humanoid_2d_9_full_{index}, range_len: {range_len}, disable_prob: {disable_prob}, "
              f"left_thigh_length: {left_thigh_length}, right_thigh_length: {right_thigh_length}, "
              f"left_shin_length: {left_shin_length}, right_shin_length: {right_shin_length}, "
...
output_file = os.path.join(output_dir, f"humanoid_2d_9_full_{index}.xml")
