...
# List joint & actuator.
joint_options = [("left1_joint", 100), ("right1_joint", 100)]
selected_joints = []
unselected_joints = []
...
with open(log_file, "a") as log:
    log.write(f"walker_3_flipped_{index}, range_len: {range_len}, disable_prob: {disable_prob}, "
...
output_file = os.path.join(output_dir, f"walker_3_flipped_{index}.xml")
