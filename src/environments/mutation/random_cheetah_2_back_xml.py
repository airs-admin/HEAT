...
ET.SubElement(actuator, "motor", gear="120", joint="bthigh", name="bthigh")

# Log the generated values
with open(log_file, "a") as log:
    log.write(f"cheetah_2_back_{index}, range_len: {range_len}, disable_prob: {disable_prob}, "
...
output_file = os.path.join(output_dir, f"cheetah_2_back_{index}.xml")
