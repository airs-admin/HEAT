...
with open(log_file, "a") as log:
    log.write(f"humanoid_2d_7_right_arm_{index}, range_len: {range_len}, disable_prob: {disable_prob}, "
...
output_file = os.path.join(output_dir, f"humanoid_2d_7_right_arm_{index}.xml")
