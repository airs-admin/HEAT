...
left_leg_2_torso_height = 0.1 + left_shin_length + 0.063 + left_thigh_length + 0.465
right_leg_2_torso_height = 0.063 + right_thigh_length + 0.465
...
ET.SubElement(left_thigh, "geom", fromto=f"0 0 0 0 -0.01 {-left_thigh_length}", name="left_thigh1", size="0.06", type="capsule")
...
# List joint & actuator.
joint_options = [("right_hip_y", 150), ("left_hip_y", 150), ("left_knee", 100), ("right_shoulder1", 12.5), 
...
with open(log_file, "a") as log:
    log.write(f"humanoid_2d_8_right_knee_{index}, range_len: {range_len}, disable_prob: {disable_prob}, "
              f"left_thigh_length: {left_thigh_length}, right_thigh_length: {right_thigh_length}, "
              f"left_shin_length: {left_shin_length}, right_shin_length: disabled, "
...
output_file = os.path.join(output_dir, f"humanoid_2d_8_right_knee_{index}.xml")
