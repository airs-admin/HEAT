...
joint_options = [("right_hip_y", 150), ("right_knee", 100), ("left_hip_y", 150), ("left_knee", 100),
                 ("right_shoulder1", 12.5), ("left_shoulder1", 12.5)]
selected_joints = []
unselected_joints = []
...
with open(log_file, "a") as log:
    log.write(f"humanoid_2d_7_lower_arms_{index}, range_len: {range_len}, disable_prob: {disable_prob}, "
...
output_file = os.path.join(output_dir, f"humanoid_2d_7_lower_arms_{index}.xml")
