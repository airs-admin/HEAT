...
def save_model_without_rb(checkpoint_path, policy, total_timesteps, life_num, num_samples, env_names, args):
    ...
    if args.save_checkpoint:
        fpath = os.path.join(checkpoint_path, f'model_{total_timesteps}.pyth')
...
def load_checkpoint_without_rb(checkpoint_path, policy, args):
    fpath = os.path.join(checkpoint_path, 'model.pyth')
